...
<table>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-low_level_programming/blob/master/0x01-variables_if_else_while/4-print_alphabt.c" target="_blank">4-print_alphabt.c</a></h2></td>
        <td>
            <p>Write a program that prints the alphabet in lowercase, followed by a new line.</p>
            <ul>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-low_level_programming/blob/master/0x01-variables_if_else_while/5-print_numbers.c" target="_blank">5-print_numbers.c</a></h2></td>
        <td>
            <p>Write a program that prints all single digit numbers of base 10 starting from 0, followed by a new line.</p>
            <ul>
                <li>All your code should be in the main function</li>
            </ul>
        </td>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-low_level_programming/blob/master/0x01-variables_if_else_while/6-print_numberz.c" target="_blank">6-print_numberz.c</a></h2></td>
        <td>
            <p>Write a program that prints all single digit numbers of base 10 starting from 0, followed by a new line.</p>
            <ul>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-low_level_programming/blob/master/0x01-variables_if_else_while/7-print_tebahpla.c" target="_blank">7-print_tebahpla.c</a></h2></td>
        <td>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-low_level_programming/blob/master/0x01-variables_if_else_while/8-print_base16.c" target="_blank">8-print_base16.</a></h2></td>
        <td>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-low_level_programming/blob/master/0x01-variables_if_else_while/9-print_comb.c" target="_blank">9-print_comb.c</a></h2></td>
        <td>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-low_level_programming/blob/master/0x01-variables_if_else_while/100-print_comb3.c" target="_blank">100-print_comb3.c</a></h2></td>
        <td>
            <p>Write a program that prints all possible different combinations of two digits</p>
            <ul>
                <li>Numbers must be separated by comma, followed by space</li>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-low_level_programming/blob/master/0x01-variables_if_else_while/101-print_comb4.c" target="_blank">101-print_comb4.c</a></h2></td>
        <td>
            ...
            <ul>
                ...
                <li>012, 120, 102, 021, 201, 210 are considered the same combination of the three digits 0, 1 and 2</li>
    ...
    <tr>
        <td><h2><a href="https://github.com/LivingDemonness28/alx-low_level_programming/blob/master/0x01-variables_if_else_while/102-print_comb5.c" target="_blank">102-print_comb5.c</a></h2></td>
        <td>
            <p>Write a program that prints all possible combinations of two two-digit numbers.</p>
            <ul>
                <li>The number should range from 0 to 99</li>
